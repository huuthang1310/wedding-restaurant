 ...
 */
add_action( 'wp_enqueue_scripts', 'wedding_restaurant_theme_register_style');
function wedding_restaurant_theme_register_style(){
	$css_Url = get_template_directory_uri() . '/css';

	wp_register_style('wedding_restaurant_theme_bt', $css_Url . '/bootstrap.min.css', array(), '1.0');
	wp_enqueue_style('wedding_restaurant_theme_bt');

	wp_register_style('wedding_restaurant_theme_fa', $css_Url . '/font-awesome.min.css', array(), '1.0');
	wp_enqueue_style('wedding_restaurant_theme_fa');

	wp_register_style('wedding_restaurant_theme_styles', $css_Url . '/styles.css', array(), '1.0');
	wp_enqueue_style('wedding_restaurant_theme_styles');

	wp_register_style('wedding_restaurant_theme_custom', $css_Url . '/custom.css', array(), '1.0');
	wp_enqueue_style('wedding_restaurant_theme_custom');
