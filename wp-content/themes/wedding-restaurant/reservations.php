						...
						<div class="col-md-5 text-center cards-pad-40 color-3 cards-title-17">
							<div class="p-40 p-md-0">
								<div class="card border-bottom-2x border-3 p-t-sm-0">
									...
									<div class="card-body">
										<h5 class="card-title">
											<a href="http://templatecs.com/demo/template/deliki/html/reservations.html#">0123 456 789</a>
										</h5>
									</div>
								</div>
								<div class="card border-bottom-2x border-3">
									...
									<div class="card-body">
										<h5 class="card-title">
											<a href="http://templatecs.com/demo/template/deliki/html/reservations.html#">info@gmail.com</a>
										</h5>
									</div>
								</div>
								<div class="card">
									...
									<div class="card-body">
										<h5 class="card-title">
											<a href="http://templatecs.com/demo/template/deliki/html/reservations.html#">1418 Riverwood Drive, Suite 3845 Cottonwood</a>
										</h5>
									</div>
								</div>
							</div>
